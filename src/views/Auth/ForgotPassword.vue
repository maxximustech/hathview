                ...
                <v-row class="px-8 py-10 px-md-15 py-md-15">
                  <v-col cols="12">
                    <slide-y-up-transition appear :delay="300">
                      <h4 class="text-h5 text-xs-h6 text-md-h4" style="font-weight: 700;">Forgot your password?</h4>
                    </slide-y-up-transition>
                    <slide-y-up-transition appear :delay="400">
                      <h6 class="text-subtitle-2 mt-2 mt-md-4" style="font-weight: 600;">Enter your email address below, we will send you a code</h6>
                    </slide-y-up-transition>
                  </v-col>
                  <v-col cols="12">
                    <v-form class="forgot-password-form">
