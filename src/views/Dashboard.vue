          ...
          <v-card flat color="transparent">
            <v-card-text class="px-0">
              ...
              <div v-if="$store.state.user.role!=='admin' && collections.length > 0">
                ...
                <v-virtual-scroll :bench="collections.length>100?100:collections.length" :items="collections" :item-height="$store.state.user.role === 'customer'?70:90" :height="collections.length>=5?500:(collections.length*90)">
              ...
              <div>
                ...
                <v-virtual-scroll :bench="transactions.length>100?100:transactions.length" :items="transactions" :item-height="120" :height="transactions.length>=5?500:(transactions.length*120)">
                  <template v-slot:default="{item}">
