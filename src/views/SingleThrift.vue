            ...
            <v-card-text class="px-0">
              ...
              <v-card class="pa-5 rounded-xl" color="white" flat>
                <div class="d-flex mb-2">
                  <v-chip class="align-self-center" dark light x-small :color="formatThriftBadgeColor('active')"><span>Active</span></v-chip>
                  <v-spacer/>
                ...
                <h4 class="text-h5 font-weight-medium text--white mb-2 text-truncate">
                  Annual 2022/23 Thrift
                </h4>
                <v-progress-linear height="10" striped class="rounded-xl" :value="75" :color="formatThriftCardColor(75)" background-color="grey lighten-1"></v-progress-linear>
